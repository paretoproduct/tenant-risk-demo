...
import { FileText, Building2, CreditCard, Calendar, MapPin, TrendingUp, Info } from "lucide-react";
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 pl-6 border-l-2 border-border">
                    <div className="flex items-start gap-3">
                      ...
                      <span className="text-sm text-muted-foreground">Late payment: 60–90 days</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <Badge variant="outline" className="font-mono text-xs min-w-[2rem] justify-center">
                        3
                      </Badge>
                      <span className="text-sm text-muted-foreground">Late payment: 90–120 days</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <Badge variant="outline" className="font-mono text-xs min-w-[2rem] justify-center">
                        4
                      </Badge>
                      <span className="text-sm text-muted-foreground">Late payment: 120–150 days</span>
                    </div>
                    <div className="flex items-start gap-3 p-2 bg-destructive/10 rounded-md border border-destructive/20">
                      ...
                      <span className="text-sm font-medium text-foreground">Judicial status</span>
                    </div>
                  </div>
                </div>
